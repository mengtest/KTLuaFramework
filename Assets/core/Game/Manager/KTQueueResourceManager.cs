...
namespace LuaFramework
{
    ...
    /// 加载一旦开始，中途不允许加入新请求
    /// </summary>
    public class KTQueueResourceManager:IDisposable
    {
        public class Loader
        {
        ...
        private KTResourceManager m_resManager = new KTResourceManager();
        ...
        public void Init()
        {
            m_resManager = new KTResourceManager();
            m_resManager.Init();
