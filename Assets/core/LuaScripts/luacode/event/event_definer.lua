...
EVENT_QUEST_ADD_TRACE = Event_counter:get_event_value()             -- 新增追踪任务
EVENT_QUEST_DEL_TRACE = Event_counter:get_event_value()             -- 取消追踪任务
...
--npc
EVENT_GIVER_STATUS = Event_counter:get_event_value()          --npc状态改变