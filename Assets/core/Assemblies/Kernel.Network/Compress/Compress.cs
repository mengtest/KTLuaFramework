...
public class Compress
{
    ...
    UInt16 inputCode(byte[] src, ref Int32 index, ref Int32 srcSize)
    {
        ...
        while (mBitCount < CodeBits)
        {
            ...
            mBitBuffer |= ((UInt32)(src[index])) << (24 - mBitCount);
            mBitCount += 8;
            index++;
        }
    ...
    static UInt16[] mMap = new UInt16[HashTableSize];

    static UInt16[] prefixCode = new UInt16[HashTableSize];
    static byte[] appendChar = new byte[HashTableSize];
}
